...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-8">
        <form class="navbar-form search" role="search" action="{{route('books.search')}}">
      ...
      <div class="col-md-4">
        <a class="btn btn-primary pull-right" href="{{route('books.create')}}"><i class="material-icons">add</i></a>
      </div>
      <div class="col-md-12">
