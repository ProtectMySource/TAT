...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-8">
        <form class="navbar-form search" role="search" action="{{route('categories.search')}}">
      ...
      <div class="col-md-4">
        <a class="btn btn-primary pull-right" href="{{route('categories.create')}}"><i class="material-icons">add</i></a>
      </div>
      <div class="col-md-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="td-actions text-right">
                    <a href="{{route('categories.edit',['category'=>$category->id])}}" type="button" rel="tooltip" title="Sửa"
                      class="btn btn-success btn-simple btn-xs">
                        <i class="fa fa-edit"></i>
                    </a>
                    <button type="button" rel="tooltip" title="Xóa"
                      class="btn btn-danger btn-simple btn-xs" data-toggle="modal"
                          data-target="#myModal" data-whatever="{{$category->id}}">
